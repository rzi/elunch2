...
<head>
<title>Orders</title>
<meta charset="UTF-8"><link rel="stylesheet" href="/www/www/css/bootstrap.min.css">
...
<section class="container">   
	<div class="container">   
		<div class="row">        
			<div class="col-xl-12 container ramkaLewa ">                 
			...
			<div class=" col-xl-12 container ramkaLewa">     
				...
				<div class="tab-content" id="myTabContent">          
					...
					<div id="dane_tabela2" class="fixed_header_d"></div>                           
					</div>                            
